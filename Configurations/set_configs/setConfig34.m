function[CONFIG]=setConfig34(CONFIG)
...
% parameters
CONFIG.parameterID = 34;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-34';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-34';
