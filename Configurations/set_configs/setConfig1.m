function[CONFIG]=setConfig1(CONFIG)
...
% parameters
CONFIG.parameterID = 1;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-1';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-1';
