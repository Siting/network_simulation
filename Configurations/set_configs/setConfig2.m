function[CONFIG]=setConfig2(CONFIG)
...
CONFIG.measConfigID = 1;

% measurement generation network
CONFIG.measNetworkID = 'CA-link-1';

% model calibration network
CONFIG.caliNetworkID = 'CA-link-2';

% parameters
CONFIG.parameterID = 2;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-2';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-2';
