function[CONFIG]=setConfig14(CONFIG)
...
% parameters
CONFIG.parameterID = 14;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-14';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-14';
