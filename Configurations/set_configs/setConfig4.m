function[CONFIG]=setConfig4(CONFIG)
...
% parameters
CONFIG.parameterID = 4;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-4';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-4';
