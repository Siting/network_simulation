function[CONFIG]=setConfig32(CONFIG)
...
CONFIG.measConfigID = 31;

% measurement generation network
CONFIG.measNetworkID = 'CA-network-1';

% model calibration network
CONFIG.caliNetworkID = 'CA-network-2';

% parameters
CONFIG.parameterID = 32;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-32';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-32';
