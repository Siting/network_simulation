function[CONFIG]=setConfig100(CONFIG)
...
% parameters
CONFIG.parameterID = 100;

% initial state
CONFIG.initialStateID = 'INITIAL_STATE_CONFIG-100';

% boundary condition
CONFIG.boundaryConditionID = 'BOUNDARY_CONDITION_CONFIG-100';
