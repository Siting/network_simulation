function[] = saveSimulationResults_network(LINK,sensorMetaDataMap_updated,numEns,numTimeSteps,samplingInterval,...
    startTime,unixTimeStep,trueStateErrorMean,trueStateErrorVar, index, configID, evolutionDataFolder,...
    CONFIG, PARAMETER)
...
saveSensorData2Mat_cali(SENSOR_DATA_MATRIX, CONFIG, PARAMETER, index);
% % boundary flows
